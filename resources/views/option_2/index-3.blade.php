...
<body>
   ...
   <main>
      ...
      <section class="banner-area fix p-relative">
         <div class="banner-bg banner-bg-rainbow" data-background="{{ asset('/assets/img/banner/banner-bg-2.jpg') }}">
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-xl-6 col-lg-6">
                     <div class="banner-shape d-none d-md-block">
                        <img src="{{ asset('/assets/img/banner/banner-img-1.png') }}" alt="banner-shape" class="b-shape-3">
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="row">
               ...
               <div class="col-xxl-3 col-lg-4 col-md-6">
                  <div class="tp-cat-item mb-40 d-flex align-items-center">
                     ...
                     <div class="tp-cat-content">
                        <h4 class="tp-category-title tp-title-small"><a href="course-grid.html">Development</a></h4>
                        <p>236 Courses</p>
                     </div>
                  </div>
               </div>
               <div class="col-xxl-3 col-lg-4 col-md-6">
                  <div class="tp-cat-item mb-40 d-flex align-items-center">
                     ...
                     <div class="tp-cat-content">
                        <h4 class="tp-category-title tp-title-small"><a href="course-grid.html">Marketing</a></h4>
                        <p>236 Courses</p>
                     </div>
                  </div>
               </div>
               <div class="col-xxl-3 col-lg-4 col-md-6">
                  <div class="tp-cat-item mb-40 d-flex align-items-center">
                     ...
                     <div class="tp-cat-content">
                        <h4 class="tp-category-title tp-title-small"><a href="course-grid.html">Software</a></h4>
                        <p>236 Courses</p>
                     </div>
                  </div>
               </div>
               <div class="col-xxl-3 col-lg-4 col-md-6">
                  <div class="tp-cat-item mb-40 d-flex align-items-center">
                     ...
                     <div class="tp-cat-content">
                        <h4 class="tp-category-title tp-title-small"><a href="course-grid.html">Videography</a></h4>
                        <p>236 Courses</p>
                     </div>
                  </div>
               </div>
               <div class="col-xxl-3 col-lg-4 col-md-6">
                  <div class="tp-cat-item mb-40 d-flex align-items-center">
                     ...
                     <div class="tp-cat-content">
                        <h4 class="tp-category-title tp-title-small"><a href="course-grid.html">Business</a></h4>
                        <p>236 Courses</p>
                     </div>
                  </div>
               </div>
               <div class="col-xxl-3 col-lg-4 col-md-6">
                  <div class="tp-cat-item mb-40 d-flex align-items-center">
                     ...
                     <div class="tp-cat-content">
                        <h4 class="tp-category-title tp-title-small"><a href="course-grid.html">Photography</a></h4>
                        <p>236 Courses</p>
                     </div>
                  </div>
               </div>
      ...
      <!-- course-area -->
      <section class="course-area pt-115 pb-100">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
               ...
               <div class="col-xl-5 col-lg-6 col-md-12">
                  <div class="tp-choose-content mb-50">
                     <div class="section-title mb-30">
                        ...
                        <p>Competently facilitate end-to-end testing procedure before customized applications. Interactively coordinate scalable.</p>
                     </div>
                        ...
                        <ul>
                           <li>
                              <div class="choose-online-item d-flex">
                                 ...
                                 <div class="choose-online-content">
                                    <h5 class="choose-online-title mb-10">Increasing Your Learning Skills</h5>
                                    <p>Holisticly parallel task diverse architectures after top-line applications. Competently facilitate end.</p>
                                 </div>
                              </div>
                           </li>
                           <li>
                              <div class="choose-online-item d-flex">
                                 ...
                                 <div class="choose-online-content">
                                    <h5 class="choose-online-title mb-10">High Quality Video & Audio Classes</h5>
                                    <p>Holisticly parallel task diverse architectures after top-line applications. Competently facilitate end.</p>
                                 </div>
                              </div>
                           </li>
                           <li>
                              <div class="choose-online-item d-flex">
                                 ...
                                 <div class="choose-online-content">
                                    <h5 class="choose-online-title mb-10">Finish Your Course, Get Certificate</h5>
                                    <p>Holisticly parallel task diverse architectures after top-line applications. Competently facilitate end.</p>
                                 </div>
                              </div>
                           </li>
      ...
      <!-- testimonial-area -->
      <section class="testimonial-area bg-bottom pt-115 pb-90 " data-background="assets/img/bg/shape-bg-1.png">
         <div class="container">
            <div class="row">
               <div class="col-lg-12">
                  <div class="section-title text-center mb-65">
      ...
      <!-- blog-area -->
      <section class="blog-area pt-115 pb-110">
         <div class="container">
            <div class="row">
               <div class="col-lg-12">
                  <div class="section-title text-center mb-65">
            ...
            <div class="row">
                  ...
                  <div class="tp-blog tp-blog-parent mb-60">
                     <div class="tp-blog__thumb">
                        <div class="fix blog-round">
                           <a href="blog-details.html"><img src="assets/img/blog/blog-thumb-3-01.jpg" alt="blog-img"></a>
                        </div>
                     </div>
                     <div class="tp-blog__content blog-edu p-relative">
                        <div class="tp-blog__meta-list mb-10">
                           <span><a href="blog-details.html"><i class="fi fi-ss-calendar"></i>21 Jan 2022</a></span>
               ...
               <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="tp-blog tp-blog-parent mb-60">
                     <div class="tp-blog__thumb">
                        <div class="fix blog-round">
                           <a href="blog-details.html"><img src="assets/img/blog/blog-thumb-3-02.jpg" alt="blog-img"></a>
                        </div>
                     </div>
                     <div class="tp-blog__content blog-edu p-relative">
                        <div class="tp-blog__meta-list mb-10">
                        ...
                        <h3 class="tp-blog__title mb-15"><a href="blog-details.html">Computer Technology & Academic Learning</a></h3>
                        <span><a href="blog-details.html"><i class="fi fi-sr-user"></i>Karim Benzamin</a></span>
                     </div>
                  </div>
               </div>
               <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="tp-blog tp-blog-parent mb-60">
                     <div class="tp-blog__thumb">
                        <div class="fix blog-round">
                           <a href="blog-details.html"><img src="assets/img/blog/blog-thumb-3-03.jpg" alt="blog-img"></a>
                        </div>
                     </div>
                     <div class="tp-blog__content blog-edu p-relative">
                        <div class="tp-blog__meta-list mb-10">
                        ...
                        <h3 class="tp-blog__title mb-15"><a href="blog-details.html">Engineering Technology & Fild Work Skill</a></h3>
                        <span><a href="blog-details.html"><i class="fi fi-sr-user"></i>Karim Benzamin</a></span>
                     </div>
                  </div>
               </div>
